...
#zakelijk
flavour = 0
noOption = 'Sorry dat is geen optie die we aanbieden...'
...
def icecreamShop():
    ...
    return {'bolletjesCount':bolletjesCount,'hornCount':hornCount, 'boxCount':boxCount}
order = icecreamShop()
print(order)
...
if amountIcecream:
    ...
    priceAmountIceCream = format(bolletjesCount*0.95, ".2f")
    ...
    if amountIcecream == 0:
        ...
        print(f'      Bolletje(s)           {bolletjesCount} x €0.95    = €{priceAmountIceCream}                                           ')
        print(f'      Bakje(s)              {boxCount} x €0.75   = €{priceBoxCount}')
    ...
    priceWithTax = float(format(priceWithoutTax/100*106, ".2f"))
    ...
    print(f'    BTW (6%)                                    = €{format(priceWithTax-priceWithoutTax, ".2f")}                                 ')
